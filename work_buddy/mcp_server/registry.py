    ...
    return [
        ...
        Capability(
            ...
            parameters={
                ...
                "calendar_events": {"type": "str", "description": "For generate: JSON list of calendar events", "required": False},
                "focused_tasks": {"type": "str", "description": "For generate: JSON list of task dicts with 'description' key", "required": False},
                "config_overrides": {"type": "str", "description": "JSON dict of day_planner config overrides", "required": False},
            },
