"""Least-authority form tools used by hosted assistance workers."""
...
def assisted_draft_reference_search(
    assistant_session_id: str,
    conversation_id: str,
    consumer: str,
    generation: str,
    ...
    """Search one form-authorized host projection; never dispatch a result."""

    try:
        return get_assistance_broker().reference_search(
            assistant_session_id=assistant_session_id,
            conversation_id=conversation_id,
            consumer=consumer,
            generation=generation,
...
register_op("op.wb.assisted_draft_reference_search", assisted_draft_reference_search)
