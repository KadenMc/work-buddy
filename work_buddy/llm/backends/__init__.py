...
No Backend protocol / abstract base class is defined here — with
only one non-Anthropic backend at the moment, the protocol would be
speculative. Introduce it when a third backend (Ollama, vLLM, etc.)
lands.
"""
