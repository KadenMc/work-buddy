"""Pure gap-filling schedule generator for native Journal plans.
...
plan entries that fit into calendar gaps. The result has no storage or plugin
dependency; Journal adapters choose how to persist it.
"""
