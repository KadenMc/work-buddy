...
dev_notes: |-
  ...
  shared with Co-work's native filesystem pickers; on other platforms the optional
...
Windows core installs already include PySide6 for Co-work's native filesystem
pickers. On other platforms, the tray needs the `tray` extra
