...
parameters:
  ...
  force:
    type: bool
    description: Rebuild every reachable vault from scratch (default false). A full rebuild encodes tens of thousands of chunks — run it via `python -m work_buddy.vault_index`, not this skill.
    required: false
skill_name: vault_index
tags:
- context
- vault
- index
