...
mutates_state: true
retry_policy: replay
skill_name: cowork_action_snapshot_get
tags:
- cowork
- document
- chat
...
skill returns `ok=false`, `status=action_snapshot_unavailable`, and a
...
After a consumer restart, call the skill again under the new generation.
