...
retry_policy: manual
auto_retry: false
skill_name: cowork_truth_analysis_job_get
tags:
- cowork
- truth
- analysis
...
This skill is available only to the server-authored
...
The skill does not grant arbitrary document, Folder, URL-fetch,
...
tools or broaden the worker's four-skill ACL.
...
further worker use. That lazy terminalization is why this skill declares
