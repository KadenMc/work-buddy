...
dashboard-react/ = React dashboard source, UI foundations, widget library, development harnesses, and browser tests. Its production build is served by the Flask dashboard at `/app`.
