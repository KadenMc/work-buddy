 ...
 * discover it by View ID with no branch on Co-work, and its loaded form additionally
 * exports the single-surface renderer (`surface`) that ViewHost mounts for a
 * single-surface view. The dashboard registry wires this at the integration join.
 */
