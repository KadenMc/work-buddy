...
import { type Mark, type MarkType, type Node } from "@tiptap/pm/model";
import {
  type Command,
  type EditorState,
  TextSelection,
...
import { findSuggestionMarkEnd } from "./findSuggestionMarkEnd";
import { suggestChangesKey } from "./plugin";
