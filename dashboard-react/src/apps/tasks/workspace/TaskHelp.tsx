...
export const TASK_HELP = {
  ...
  namespaceFilter: hint("Cycle this namespace filter through three states.", "Activate with a click or Space: blank → checkmark (this namespace and descendants) → filled box (this namespace only) → blank. Multiple selections match any selected namespace, combined with other filters. Counts follow those other filters. This never edits task assignments."),
